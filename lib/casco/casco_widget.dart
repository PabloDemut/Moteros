...
class CascoWidget extends StatefulWidget {
  const CascoWidget({Key key}) : super(key: key);

  @override
  _CascoWidgetState createState() => _CascoWidgetState();
}

class _CascoWidgetState extends State<CascoWidget> {
