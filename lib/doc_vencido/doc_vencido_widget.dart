...
class DocVencidoWidget extends StatefulWidget {
  const DocVencidoWidget({Key key}) : super(key: key);

  @override
  _DocVencidoWidgetState createState() => _DocVencidoWidgetState();
}

class _DocVencidoWidgetState extends State<DocVencidoWidget> {
                        ...
                        children: [
                          Padding(
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.asset(
                                'assets/images/INMOVILIZACION_(10).png',
                                width: 230,
                                height: 400,
